...
public class addemp extends javax.swing.JFrame implements ActionListener {
 ...
 connections c=new connections();
  ...
  addemp(String f, String u)
  {
       s=u;
           id=f;
          bk = new JButton("BACK");
          bk.setBounds(750, 580, 200, 70);
          j1=new JFrame();
          j1.setLayout(null);
          j1.setSize(1000,800);
          j1.setVisible(true);
   ...
   void details()
  {
   ...
   void search_employee()
   {
       try{
           ...
           c.stmt.setInt(1, Integer.parseInt(id));
   ...
   void modemp()
   {
       ...
       c.stmt=c.con.prepareCall("update employee set ID=?,NAME=?,GENDER=?,CONTACT_NO=?,EMAIL=?,ADDRESS=?,DEPT=?,L_O_S=?,SALARY=?");
        ...
        JOptionPane.showMessageDialog(this, "MODIFIED");
            ...
            JOptionPane.showMessageDialog(this, "FILL PARTICULARS PROPERLY");
       }
       catch(Exception ee){System.out.println(ee);

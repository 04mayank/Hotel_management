...
public class employee extends javax.swing.JFrame implements ActionListener {
  JFrame j1;
  JButton bh,brm,brs,bt,bcd,bevnt,bemp,bk,addemp,rememp,sremp,modemp;
  JTextField t20; 
 ...
 bevnt= new JButton("EVENTS");
 bevnt.setBounds (380,600,200,60);
 bevnt.setFont(f1);
    ...
    void add()
    {
        try{
         i=0;
           ...
           if(i==0)
           {
               addemp ae=new addemp(t20.getText(),"add");
               j1.dispose();
           }
           else
           JOptionPane.showMessageDialog(this, "ALREADY PRESENT");    
    }
    ...
    void search()
    {
        try{
         ...
         i=0;
           ...
           {
               j1.dispose();
              addemp ae=new addemp(t20.getText(),"srch");
           }
           else
           JOptionPane.showMessageDialog(this, "DOES NOT PRESENT");  
    }
    ...
    void mod()
    {
        try{
         i=0;
           ...
           {
               j1.dispose();
              addemp ae=new addemp(t20.getText(),"mod");
           }
           else
               JOptionPane.showMessageDialog(this, "DOES NOT PRESENT");
    }
